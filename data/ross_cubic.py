...
glob_search = pathlib.Path("ross_2023/").rglob("*/*")
targets = [p for p in glob_search if p.is_dir()]
...
for target in targets:
    ...
    with open(target / "waters_cubic_default.json", "r") as fd:
...
with open("ross_cubic.json", "w") as fd:
